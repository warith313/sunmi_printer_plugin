...
class SunmiPrinter {
  ...
  static const MethodChannel _channel = MethodChannel('sunmi_printer_plugin');
  ...
  static Future<void> printBarCode(String data,
    ...
    Map<String, dynamic> arguments = <String, dynamic>{"data": data, 'barcodeType': codeType, 'textPosition': textPosition0, 'width': width, 'height': height};

  ...
  public void onMethodCall(@NonNull MethodCall call, @NonNull Result result) {
    switch (call.method) {
      ...
      case "PRINT_TEXT":
        ...
        break;
      case "RAW_DATA":
        sunmiPrinterMethod.sendRaw(call.argument("data"));
        result.success(true);
        break;
      case "PRINT_QRCODE":
      ...
      case "LCD_BITMAP":
        ...
        Bitmap lcdBitmap = BitmapFactory.decodeByteArray(
                lcdBitmapData, 0, Objects.requireNonNull(lcdBitmapData).length);
      ...
      case "LCD_MULTI_STRING":
        ...
        String[] lcdText = Utilities.arrayListToString(Objects.requireNonNull(lcdTextAL));
        ArrayList<Integer> lcdAlignAL = call.argument("align");
        int[] lcdAlign = Utilities.arrayListToIntList(Objects.requireNonNull(lcdAlignAL));
